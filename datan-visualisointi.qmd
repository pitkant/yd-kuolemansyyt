...
# Relevanttien pakettien lataaminen
...
# kuolemat <- rbind(itsemurhat_vakivalta, huumekuolemat)
...
ggplot(itsemurhat_ikaryhmat, aes(fill = ika, y=kuolleet_06_23, x=vuosi)) +
...
ggplot(vakivalta_ikaryhmat, aes(fill = ika, y=kuolleet_06_23, x=vuosi)) +
  geom_bar(position="dodge", stat="identity") + 
...
ggplot(huumekuolemat_ikaryhmat, aes(fill = ika, y=kuolleet_06_23, x=vuosi)) +
  geom_bar(position="dodge", stat="identity") + 
...
ggplot(itsemurhat_sp, aes(fill = sukupuoli, y=kuolleet_06_23_sp, x=vuosi)) +
  geom_bar(position="dodge", stat="identity") + 
  labs(title = "Itsemurhiin kuolleet 15-29 -vuotiaat 2006-2023",
       caption = "Lähde: Tilastokeskus / StatFin (statfin_ksyyt_pxt_11az)",
       x = "Vuosi",
...
ggplot(vakivalta_sp, aes(fill = sukupuoli, y=kuolleet_06_23_sp, x=vuosi)) +
  geom_bar(position="dodge", stat="identity") + 
  labs(title = "Väkivaltaan kuolleet 15-29 -vuotiaat 2006-2023",
       caption = "Lähde: Tilastokeskus / StatFin (statfin_ksyyt_pxt_11az)",
       x = "Vuosi",
...
ggplot(huumekuolemat_sp, aes(fill = sukupuoli, y=kuolleet_06_23_sp, x=vuosi)) +
  geom_bar(position="dodge", stat="identity") + 
  labs(title = "Huumeisiin kuolleet 15-29 -vuotiaat 2006-2023",
       caption = "Lähde: Tilastokeskus / StatFin (statfin_ksyyt_pxt_12d9)",
       x = "Vuosi",
...
ggplot(kaikki_long, aes(fill = kuolemansyy, y=value, x=vuosi)) +
