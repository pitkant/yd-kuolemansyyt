...
Tässä välissä muokkauksia on tehty Excel-tiedostossa, jonka jälkeen se luetaan taas R:ään. Fontti on asetettu seuraavissa taulukoissa pieneksi jotta ne mahtuvat vaakasuunnassa pdf-tiedostoon.
...
Mustavalkoinen kuvio, joissa on mukana title, caption ja y-akselin label:
