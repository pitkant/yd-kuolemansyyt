...
kuvio2 <- ggplot(huumekuolemat_ikaryhmat_2, aes(fill = ika, y=kuolleet_06_24, x=as.numeric(vuosi))) +
  geom_bar(position="dodge", stat="identity", color = "black", size = 0.25) + 
  labs(x = "Vuosi",
       y = "",
       fill = "Ikäryhmä") +
...
kuvio3 <- ggplot(vakivalta_ikaryhmat_2, aes(fill = ika, y=kuolleet_06_24, x=as.numeric(vuosi))) +
  geom_bar(position="dodge", stat="identity", color = "black", size = 0.25) + 
  labs(x = "Vuosi",
       y = "",
       fill = "Ikäryhmä") +
...
kuvio4 <- ggplot(kaikki_long) + 
  aes(x = as.numeric(vuosi), fill = kuolemansyy, weight = value, by = vuosi) +
