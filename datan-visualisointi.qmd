...
if (tuota_vektorikuviot) {
  ggsave("prepared_plots/analyysit_remake/kuvio2_13x8.pdf", plot = kuvio4, width = 130, height = 80, units = "mm", dpi = 300, scale = 1)
}
```
...
kuvio5 <- ggplot(data = kaikki_70_asdr, aes(x = as.numeric(vuosi), y = asdr, group = kuolemansyy)) +
  ...
  labs(x = "Vuosi",
       y = "Ikävakioitu kuolleisuusluku (per 1000)",
...
if (tuota_vektorikuviot) {
  ...
  ggsave("prepared_plots/analyysit_remake/kuvio1_13x8.pdf", plot = kuvio5, width = 130, height = 80, units = "mm", dpi = 300, scale = 1)
}
```
