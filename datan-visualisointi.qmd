...
```{r}
yd_kuolemat_kaikki %>% 
  rename(itsem_m = "itsemurha_Miehet", itsem_n = "itsemurha_Naiset", vakiv_m = "vakivalta_Miehet", vakiv_n = "vakivalta_Naiset", huume_m = "huumekuolema_Miehet", huume_n = "huumekuolema_Naiset")
```
