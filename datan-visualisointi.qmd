...
```{r 1_yd_kuolemansyyt_visualisointi_stack_luonnos, eval = FALSE}
ggplot() +
  # geom_bar(data = itsemurhat_ikaryhmat_total, aes(y = total, x=as.numeric(vuosi)), stat="identity", position="dodge") +
...
```{r 2_yd_kuolemansyyt_sukupuolittain_visualisointi_luonnos, eval = FALSE}
...
```{r 3_yd_kuolemansyyt_vs_muut_visualisointi_luonnos, eval = FALSE}
...
```{r 4_yd_kuolemansyyt_vs_muut_1969_visualisointi_luonnos, eval = FALSE}
...
```{r 4_yd_kuolemansyyt_vs_muut_1970_visualisointi_asdr_luonnos, eval = FALSE}
