...
```{r lue_valmistelu_excel_tiedosto}
...
knitr::kable(yd_kuolemat_muokattu_itsemurhat, format = "pipe", caption = "Itsemurhat", row.names = FALSE, digits = 1) %>% kableExtra::kable_styling(font_size = 2)
knitr::kable(yd_kuolemat_muokattu_huumekuolemat, format = "pipe", caption = "Huumekuolemat", row.names = FALSE, digits = 1) %>% kableExtra::kable_styling(font_size = 2)
knitr::kable(yd_kuolemat_muokattu_vakivalta, format = "pipe", caption = "Väkivaltakuolemat", row.names = FALSE, digits = 1) %>% kableExtra::kable_styling(font_size = 2)
knitr::kable(yd_kuolemat_muokattu_yhteensa, format = "pipe", caption = "Kaikki YD-kuolemat yhteensä", row.names = FALSE, digits = 1) %>% kableExtra::kable_styling(font_size = 2)
```
